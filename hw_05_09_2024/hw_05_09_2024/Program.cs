...
namespace StoreApp
{
    ...
    abstract class Device
    {
        ...
        public Device(decimal price, string vendor, Category category, int yearOfRelease, int guarantee, string model)
        {
            this.price = price;
            this.vendor = vendor;
    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            store.AddDevice(new Phone(799m, "Apple", 2022, 1, "iPhone 13 Pro"));
            store.AddDevice(new Tablet(599m, "Samsung", 2021, 1, "Galaxy Tab S7"));
            store.AddDevice(new Charger(49m, "Apple", 2022, 2, "MHJE3ZM 20W"));
            store.AddDevice(new Case(29m, "Apple", 2022, 1, "iPhone 13 Pro Case"));
